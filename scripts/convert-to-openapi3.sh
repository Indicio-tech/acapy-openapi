...
curl -X POST http://${DOCKER_CONTAINER_HOST:-localhost}:8080/api/convert -H "Content-Type: application/json" -H "Accept: application/yaml" --data-binary "@../swagger.json" -o ../openapi.yml
